...
async function newAccount(){
    let investments =   await credits.checkInvestments(currentAddress).call()
    let sponsorships = await credits.checkCurrentSponsorships(currentAddress).call()
    let title, msg
    let withdrawals = await credits.checkWithdrawals(currentAddress).call()
...
async function showUserStats() {
    ...
    let stakePercent = totalSupply > 0n
